...
class aLauncherGradient {
  final String uuid;
  final String name;
  final Gradient gradient;

  aLauncherGradient(this.uuid, this.name, this.gradient);
}

mixin aLauncherGradients {
  static final greatWhale = aLauncherGradient(
  ...
  static final viciousStance = aLauncherGradient(
  ...
  static final teenNotebook = aLauncherGradient(
  ...
  static final farawayRiver = aLauncherGradient(
  ...
  static final grassShampoo = aLauncherGradient(
  ...
  static List<aLauncherGradient> get all => [
        greatWhale,
        viciousStance,
        teenNotebook,
        oldHat,
