...
abstract class _$aLauncherDatabase extends GeneratedDatabase {
  _$aLauncherDatabase(QueryExecutor e) : super(SqlTypeSystem.defaultInstance, e);
  _$aLauncherDatabase.connect(DatabaseConnection c) : super.connect(c);
